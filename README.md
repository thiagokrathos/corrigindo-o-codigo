...
```
> git clone https://github.com/thiagokrathos/corrigindo-o-codigo.git
```

- Navegue até o diretório principal do projeto

```
> cd corrigindo-o-codigo
```
...
Feito com 💜 by <a href="https://www.linkedin.com/in/thiago-almeida-54140b128/">Thiago Almeida</a> :wave:
